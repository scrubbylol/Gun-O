...
namespace Invector.CharacterController
{
    public abstract class vThirdPersonMotor : MonoBehaviour
    {
        ...
        public float strafeWalkSpeed = 3.0f;
        [Tooltip("Add extra speed for the locomotion movement, keep this value at 0 if you want to use only root motion speed.")]
        public float strafeRunningSpeed = 3.5f;
        [Tooltip("Add extra speed for the locomotion movement, keep this value at 0 if you want to use only root motion speed.")]
		...
		public GameObject rifleMuzzleFx;
		public GameObject knifeObject;
		public GameObject knifeBack;
		public GameObject bulletPrefab;
		public GameObject bulletHolePrefab;
		public GameObject bulletHoleFxPrefab;
		public GameObject bloodFxPrefab;
		public GameObject crosshairPrefab;
		public GameObject rifleClipObject;
		...
		[HideInInspector]
		public bool rifleClipDropped;
		[HideInInspector]
		public bool newRifleClipGot;
		[HideInInspector]
		public bool setNewRifleClip;
		[HideInInspector]
		...
		public AudioClip[] concreteStepsSound;
		public AudioClip knifeDeploySound;
		public AudioClip rifleDeploySound;
        ...
        void StrafeMovement()
        {
			...
			if (input != Vector2.zero && targetDirection.magnitude > 0.1f) {
				...
				if (moveTimer >= (isSprinting ? 0.275f : 0.425f) && isGrounded) {
					int randStep = UnityEngine.Random.Range (0, 5);
					audSource.PlayOneShot (concreteStepsSound [randStep], 0.05f);
					moveTimer = 0;
				}
        ...
        public virtual void FreeMovement()
        {
            ...
            if (input != Vector2.zero && targetDirection.magnitude > 0.1f)
            {
				...
				moveTimer += Time.deltaTime;
				if (moveTimer >= (isSprinting ? 0.285f : 0.465f) && isGrounded) {
					int randStep = UnityEngine.Random.Range (0, 5);
					audSource.PlayOneShot (concreteStepsSound [randStep], 0.05f);
					moveTimer = 0;
				}
